...
void GLSLProgram::releaseResources()
{
	if (handle == 0) return;
	// Query the number of attached shaders
	GLint numShaders = 0;
...
//GLSLProgram::GLSLProgram(const char *vertexShaderPath, const char *fragmentShaderPath)
//{
//	compileShader(vertexShaderPath, GLSLShader::VERTEX);
//	compileShader(fragmentShaderPath, GLSLShader::FRAGMENT);
//}
